...
"""Blast wzy gene sequences against Genbank


Example:
        $ python blast_wzx_genes .
...
if __name__ == "__main__":
    ...
    dutil = DownloadUtils(args.output_directory, 'Escherichia coli', ['wzy'], parser, None)
